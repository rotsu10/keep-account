...
<template>
	<view>
		...
		<view class="user">
			<van-image class="photo" round src="https://fastly.jsdelivr.net/npm/@vant/assets/cat.jpeg" alt="头像" />
		...
		<view>
			<view class="ledger" @click="goToLedgerDetail">
				...
				<van-row justify="space-around" align="left" class="ledger-data-row">
					<van-col span="12">创建时间:{{ dayjs(ledgerStore.createTime).format('YYYY/MM/DD') }}</van-col>
				</van-row>
				<van-divider
				...
				<van-row justify="space-around" align="center" class="ledger-data-row">
					...
					<van-col span="12">总支出:{{ ledgerStore.totalOutcomeAmount }}</van-col>
				</van-row>
